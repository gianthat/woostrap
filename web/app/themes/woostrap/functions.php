...
add_action('woocommerce_before_main_content', 'bonestrap_wrapper_start', 10);
add_action('woocommerce_after_main_content', 'bonestrap_wrapper_end', 10);

function bonestrap_wrapper_start() {
  echo '<div id="content"><div id="inner-content" class="container shop-container" role="main">';
}

function bonestrap_wrapper_end() {
  echo '</div></div>';
}
